const features = [
  ...
  {
    title: 'Carrier Tendering & Portal',
    description: 'Broadcast or waterfall carrier tenders with EDI 204/990 integration. Carriers bid through a dedicated portal with full tender history and win rate tracking.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'X12 850, 856, 204, 990, 214, 997, and more. Unified trading partner model with SFTP/HTTP delivery, auto-acknowledgment, and inbound file routing.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
      </svg>
  ...
  },
  {
    ...
    description: 'Per-lane planned routes with Google Maps drag-to-edit, configurable deviation corridors, and automatic alerting when in-transit shipments stray off the expected path.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: 'CQRS Event Architecture',
    description: '20+ command handlers, immutable event store, 6 read model projections. Every state change is an event  - perfect for audit trails, analytics, and data pipelines.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Handlebars-based document templates for BOLs, shipping labels, and customs forms. PDF generation, daily ops Excel reports, and S3-compatible file storage.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Full CSS variable theming with admin UI. Upload your logo, configure colors, and brand every document. Multi-tenant ready with per-organization customisation.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Pluggable email service with SMTP, SendGrid, or SES. Event-triggered notifications for delays, exceptions, and deliveries. In-app notification centre included.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function Features() {
  return (
    <section id="features" className="relative py-32 bg-surface-950">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary-500/20 bg-primary-500/10 px-4 py-1.5 mb-6">
            <span className="text-sm font-medium text-primary-300">Platform Capabilities</span>
          </div>
          ...
          {features.map((feature) => (
            <div
              ...
              className={`feature-card rounded-2xl p-8 ${
                feature.highlight
                  ? 'bg-gradient-to-br from-primary-600/10 to-accent-600/10 border border-primary-500/20'
                  : 'glass-card'
              }`}
            >
